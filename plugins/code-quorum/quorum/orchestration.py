...
REVIEW_PROMPT = (
    ...
    "REPRO: <command or test that shows it, with expected vs observed; or "
    '"none">\n'
    "\n"
    "A critical or high severity requires a REPRO the host can run; a finding "
    "without one must be reported as low.\n"
    "\n"
    ...
    "treat it as a finding to push on or converge toward. A REPRO does not "
    "bring an out-of-scope finding back in scope.\n"
    "{scope}"
    "\n"
    "Change under review:\n"
    "{diff}\n"
